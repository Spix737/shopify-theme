    ...
    <div className='relative'>
      <div className='cursor-pointer'>
        <svg onClick={() => setIsOpen(true)}
          className={`item-center`} aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">      <path d="M2.00024 6H24.0002" stroke="currentColor" stroke-width="1.5"></path>      <path d="M2 13H24" stroke="currentColor" stroke-width="1.5"></path>      <path d="M2.00024 20H24.0002" stroke="currentColor" stroke-width="1.5"></path>    </svg>
      </div>
            ...
            <div className="fixed text-[46321f] overflow-x-hidden text-lg font-light top-0 left-0 flex justify-center min-h-full transition bg-[#eeece8] w-80 border-[0.5px] border-r-black">
              ...
              <Dialog.Panel className="flex flex-col py-6 mx-auto space-x-1 mr-4 bg-[#eeece8] rounded w-72">
                ...
                <div onClick={() => setAboutOpen(true)} className='flex flex-row items-center cursor-pointer place-content-between'>
                  <p className='py-2' ref=''>About Us</p>
                  <svg className="-rotate-90 icon-chevron-small" aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none"><path d="M1 1L5 5L9 1" stroke="currentColor"></path></svg>
                </div>
                ...
                <Dialog.Panel className="flex flex-col py-6 mx-auto space-x-1 mr-4 bg-[#eeece8] rounded w-72">
                  <div className=''>
                    <Dialog.Title className='relative flex flex-row items-center justify-center px-1 pb-5 space-x-2 text-lg border cursor-pointe border-b-[#cdc9c0] border-t-0 border-l-0 border-r-0'>
                      <svg onClick={() => setAboutOpen(false)} className="w-8 h-[9px] flex-no-shrink absolute left-0 top-[5px] rotate-90" aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox='0 0 3 6' fill="none"><path d="M1 1L5 5L9 1" stroke="currentColor"></path></svg>
      ...
      {isOpen &&
        <div className={`z-50 ${isOpen ? 'opacity-100' : 'opacity-0'} text-xl fixed top-4 right-12 ease-in-out duration-300 text-[#cdc9c0]`}>
          <svg onClick={() => { setIsOpen(false); setAboutOpen(false) }}
            className="icon-close " aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M1 1L17 17M17 1L1 17" stroke="currentColor" stroke-width="1.5"></path></svg>
        </div>
      }
    </div>
  )
