        ...
        <div className="pb-[16px] lg:pb-[10px] space-x-6 tracking-widest font-medium text-[.8125rem] lg:flex">
          ...
          <div onMouseOver={handleMouseOver}>
            ...
            <div className='items-center hidden space-x-2 cursor-pointer lg:flex navbar-item'>
              ...
              <svg className="icon-chevron-small " aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none"><path d="M1 1L5 5L9 1" stroke="currentColor"></path></svg>
            </div>
            {isHovering && (
          ...
          <div className="relative hidden text-left lg:inline-block">
            <a className='flex items-center space-x-3 navbar-item' onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} href=''>ABOUT US</a><svg className="icon-chevron-small " aria-hidden="true" focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none"><path d="M1 1L5 5L9 1" stroke="currentColor"></path></svg>
            {isHovering && (
