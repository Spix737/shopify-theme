...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className={`sticky left-2 z-40 bg-[#eeece8] pointer-events-none lg:bg-transparent top-0 h-[52px] lg:border-b-0 ${visible ? 'border border-t-0 border-l-0 border-r-0 border-b-[#cdc9c0] border-b-1' : ''}`}>
      ...
      <div className='z-50 flex justify-center pt-5 mx-auto mb-4 lg:mb-11 lg:pt-0'>
        <img
      ...
      <div className='bg-[#eeece8] sticky z-30 top-0 flex flex-row justify-center lg:pt-4 lg:pb-1 border border-t-0 border-l-0 border-r-0 border-b-[#cdc9c0] border-b-1'>
